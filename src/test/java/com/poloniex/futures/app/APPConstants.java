...
public class APPConstants {
    ...
    public static String kline_list = "app/v1/kumex-kline/history";//网路ok

    public static String open_contract = "app/v1/kumex/user/open-contract";

    public static String favorite_symbol = "app/v1/ucenter/favorite-symbol"; //网路ok
    public static String a = "/v1/ucenter/favorite-symbol/add";
    public static String b = "/v1/ucenter/favorite-symbol/stick";
